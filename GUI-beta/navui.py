...
def navigation_ui(title):
    ...
    with mydrawer:
        ...
        with ui.column().classes('w-full gap-1'):
            ...
            ui.button('Dijkstra', icon='calculate', on_click=lambda: ui.navigate.to('/D_analysis')).classes('w-full text-lg').props('flat color=black align=left')
            ui.button('Grassfire', icon='calculate', on_click=lambda: ui.navigate.to('/G_analysis')).classes('w-full text-lg').props('flat color=black align=left')
